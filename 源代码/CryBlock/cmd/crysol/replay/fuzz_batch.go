...
import (
	...
	"github.com/ethereum/go-ethereum/cmd/CryBlock/abi"
	"github.com/ethereum/go-ethereum/cmd/CryBlock/fuzz"
...
func FuzzBatch(ctx *cli.Context) error {
	...
	for _, addr := range contractList {
		...
		if timeCounter % 100 == 0{
			fmt.Println("Timer", timeCounter, time.Since(BatchStartTime))
		}
	...
	fmt.Println(timeCounter, time.Since(BatchStartTime))
